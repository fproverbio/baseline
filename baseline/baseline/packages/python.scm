...
(define-public python-instagram-private-api
  (package
   (name "python-instagram-private-api")
   (version "1.6.0.0")
   (source (origin
            (method url-fetch)
            (uri (pypi-uri "instagram_private_api" version))
            (sha256
             (base32
              "13jxvz76g2aakk0m88rd7ypm4jk6z813p3225s5vk0d8bb5w5q6z"))))
   (build-system python-build-system)
   (home-page "https://github.com/ping/instagram_private_api/tree/master")
   (synopsis "A client interface for the private Instagram API.")
   (description
    "This package provides a client interface for the private Instagram API.")
   (license license:expat)))

(define-public python-osintgram
  (let ((commit "c7948b75cd927e27f9af4887025218422687e6fd"))
    (package
     (name "python-osintgram")
     (version "1.3")
     (source (origin
	      (method git-fetch)
	      (uri (git-reference
	      ...
	      (sha256
	       (base32
		"004l0v8k2lxn4nnv3kadmx48aldfrj2s3lbcy1cxkvj2jb5n03ry"))))
     ...
     (inputs (list python-requests
		   ...
		   readline
		   python-prettytable))
     (home-page "https://github.com/Datalux/Osintgram")
     (synopsis ",")
     (description ",")
     (license #f))))
